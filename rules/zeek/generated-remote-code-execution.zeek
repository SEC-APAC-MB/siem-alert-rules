...
# Auto-generated: 2026-09-26T04:05:06.159614Z
...
signature ZK-REMOTE-CODE-EXECUTION-002 {
	ip-proto tcp
	dst-port = { 80 443 8080 8443 }
	http-request /.*((powershell|cmd\.exe|bash|python|perl|ruby)).*/ regex
	event "CVE-2026-94127 — BIG-IP APM Exploitation"
}
...
signature ZK-REMOTE-CODE-EXECUTION-006 {
	...
	dst-port = { 80 443 8080 8443 }
	http-request /.*((powershell|cmd\.exe|bash|python|perl|ruby)).*/ regex
	event "CVE-2026-85102 — Multiple Products Exploitation"
}
...
signature ZK-REMOTE-CODE-EXECUTION-017 {
	...
	dst-port = { 80 443 8080 8443 }
	http-request /.*((powershell|cmd\.exe|bash|python|perl|ruby)).*/ regex
	event "CVE-2026-42018 — Artifactory Exploitation"
}
