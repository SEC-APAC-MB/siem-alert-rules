resource "oci_cloud_guard_detector_recipe" "oci-mitre-0603" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0603: Event Triggered Execution: WMI"
  description     = "Detects Event Triggered Execution: WMI (T1546.003)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0603_conditions"
      operator   = "OR"
