resource "oci_cloud_guard_detector_recipe" "oci-mitre-0611" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0611: Access Token Manipulation: Impersonation"
  description     = "Detects Access Token Manipulation: Impersonation (T1134.001)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0611_conditions"
      operator   = "OR"
