resource "oci_cloud_guard_detector_recipe" "oci-mitre-0627" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0627: Account Discovery"
  description     = "Detects Account Discovery (T1087)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0627_conditions"
      operator   = "OR"
