resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-069" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-069: Serverless Function Injection"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-069_conditions"
      operator   = "OR"
