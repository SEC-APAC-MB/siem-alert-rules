resource "oci_cloud_guard_detector_recipe" "ghadv-0017" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-0017: netty-incubator-codec-ohttp: BinaryHttpParser should enforce limits for variable lengths fields"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-0017_conditions"
      operator   = "OR"
