resource "oci_cloud_guard_detector_recipe" "oci-general-018" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-GENERAL-018: CVE-2026-55040 \u2014 SharePoint Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-GENERAL-018_conditions"
      operator   = "OR"
