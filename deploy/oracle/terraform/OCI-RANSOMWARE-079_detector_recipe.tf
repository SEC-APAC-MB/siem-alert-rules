resource "oci_cloud_guard_detector_recipe" "oci-ransomware-079" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-079: Ransom Note Creation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-079_conditions"
      operator   = "OR"
