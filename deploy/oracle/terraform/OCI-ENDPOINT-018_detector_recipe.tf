resource "oci_cloud_guard_detector_recipe" "oci-endpoint-018" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ENDPOINT-018: CVE-2026-33824 \u2014 Internet Key Exchange (IKE) Service Extensions Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ENDPOINT-018_conditions"
      operator   = "OR"
