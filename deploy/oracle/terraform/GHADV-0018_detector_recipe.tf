resource "oci_cloud_guard_detector_recipe" "ghadv-0018" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-0018: netty-incubator-codec-ohttp: Binary HTTP parser infinite loop on known-length field section boundary"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-0018_conditions"
      operator   = "OR"
