resource "oci_cloud_guard_detector_recipe" "oci-zero_day-090" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-090: Memory Injection Pattern Detection"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-090_conditions"
      operator   = "OR"
