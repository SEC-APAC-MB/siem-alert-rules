resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-074" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-074: Lambda Environment Variable Exfiltration"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-074_conditions"
      operator   = "OR"
