resource "oci_cloud_guard_detector_recipe" "oci-zero_day-093" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-093: Process Hollowing Indicator"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-093_conditions"
      operator   = "OR"
