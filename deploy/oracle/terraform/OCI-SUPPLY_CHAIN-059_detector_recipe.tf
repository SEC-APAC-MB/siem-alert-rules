resource "oci_cloud_guard_detector_recipe" "oci-supply_chain-059" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SUPPLY_CHAIN-059: Compromised CI/CD Pipeline"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SUPPLY_CHAIN-059_conditions"
      operator   = "OR"
