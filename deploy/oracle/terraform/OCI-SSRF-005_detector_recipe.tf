resource "oci_cloud_guard_detector_recipe" "oci-ssrf-005" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SSRF-005: CVE-2026-64849 \u2014 MLflow Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SSRF-005_conditions"
      operator   = "OR"
