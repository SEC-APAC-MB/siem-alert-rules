resource "oci_cloud_guard_detector_recipe" "oci-mitre-0607" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0607: Command Scripting: PowerShell"
  description     = "Detects Command Scripting: PowerShell (T1059.001)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0607_conditions"
      operator   = "OR"
