resource "oci_cloud_guard_detector_recipe" "oci-supply_chain-064" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SUPPLY_CHAIN-064: Secret Leakage in CI Logs"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SUPPLY_CHAIN-064_conditions"
      operator   = "OR"
