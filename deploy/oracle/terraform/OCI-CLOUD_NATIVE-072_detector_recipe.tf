resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-072" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-072: S3 Bucket Policy Misconfiguration"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-072_conditions"
      operator   = "OR"
