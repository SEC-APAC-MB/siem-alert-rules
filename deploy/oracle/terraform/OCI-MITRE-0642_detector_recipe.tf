resource "oci_cloud_guard_detector_recipe" "oci-mitre-0642" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0642: Network Denial of Service"
  description     = "Detects Network Denial of Service (T1498)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0642_conditions"
      operator   = "OR"
