resource "oci_cloud_guard_detector_recipe" "oci-ai_llm_attacks-048" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-AI_LLM_ATTACKS-048: PII Disclosure via LLM"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-AI_LLM_ATTACKS-048_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-AI_LLM_ATTACKS-048"
