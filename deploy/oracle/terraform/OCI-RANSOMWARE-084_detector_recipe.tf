resource "oci_cloud_guard_detector_recipe" "oci-ransomware-084" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-084: Lateral Movement via PsExec/WMI"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-084_conditions"
      operator   = "OR"
