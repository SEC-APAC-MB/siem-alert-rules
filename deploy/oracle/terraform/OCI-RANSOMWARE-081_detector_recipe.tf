resource "oci_cloud_guard_detector_recipe" "oci-ransomware-081" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-081: Backup Deletion via Vssadmin"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-081_conditions"
      operator   = "OR"
