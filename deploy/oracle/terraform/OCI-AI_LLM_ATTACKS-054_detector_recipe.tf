resource "oci_cloud_guard_detector_recipe" "oci-ai_llm_attacks-054" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-AI_LLM_ATTACKS-054: Model Poisoning Detection"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-AI_LLM_ATTACKS-054_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-AI_LLM_ATTACKS-054"
