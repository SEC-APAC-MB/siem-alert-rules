resource "oci_cloud_guard_detector_recipe" "oci-supply_chain-062" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SUPPLY_CHAIN-062: Compromised Update Server"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SUPPLY_CHAIN-062_conditions"
      operator   = "OR"
