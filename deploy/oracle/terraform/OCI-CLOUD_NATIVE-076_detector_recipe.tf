resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-076" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-076: Service Mesh Policy Bypass"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-076_conditions"
      operator   = "OR"
