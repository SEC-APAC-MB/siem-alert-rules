resource "oci_cloud_guard_detector_recipe" "oci-remote-code-execution-020" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-REMOTE-CODE-EXECUTION-020: CVE-2025-62593 \u2014 Ray Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-REMOTE-CODE-EXECUTION-020_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-REMOTE-CODE-EXECUTION-020"
