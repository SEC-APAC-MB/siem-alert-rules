resource "oci_cloud_guard_detector_recipe" "oci-zero_day-092" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-092: Abnormal Token Privilege Elevation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-092_conditions"
      operator   = "OR"
