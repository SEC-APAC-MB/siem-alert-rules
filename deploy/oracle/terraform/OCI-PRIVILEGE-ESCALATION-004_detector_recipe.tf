resource "oci_cloud_guard_detector_recipe" "oci-privilege-escalation-004" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-PRIVILEGE-ESCALATION-004: CVE-2026-53362 \u2014 Kernel Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-PRIVILEGE-ESCALATION-004_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-PRIVILEGE-ESCALATION-004"
