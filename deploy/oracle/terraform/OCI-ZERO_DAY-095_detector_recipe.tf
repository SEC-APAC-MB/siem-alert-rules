resource "oci_cloud_guard_detector_recipe" "oci-zero_day-095" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-095: Unusual Named Pipe Activity"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-095_conditions"
      operator   = "OR"
