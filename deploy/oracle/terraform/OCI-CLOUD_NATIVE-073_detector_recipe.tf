resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-073" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-073: ECS Task Definition Tampering"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-073_conditions"
      operator   = "OR"
