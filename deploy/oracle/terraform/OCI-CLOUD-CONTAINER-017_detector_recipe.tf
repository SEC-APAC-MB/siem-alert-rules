resource "oci_cloud_guard_detector_recipe" "oci-cloud-container-017" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD-CONTAINER-017: CVE-2026-59310 \u2014 VMware vCenter Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD-CONTAINER-017_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-CLOUD-CONTAINER-017"
