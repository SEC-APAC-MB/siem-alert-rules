resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-068" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-068: Kubernetes RBAC Privilege Escalation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-068_conditions"
      operator   = "OR"
