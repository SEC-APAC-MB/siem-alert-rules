resource "oci_cloud_guard_detector_recipe" "oci-supply_chain-063" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SUPPLY_CHAIN-063: Build Pipeline Injection"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SUPPLY_CHAIN-063_conditions"
      operator   = "OR"
