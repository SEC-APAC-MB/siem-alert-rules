resource "oci_cloud_guard_detector_recipe" "oci-auth-015" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-AUTH-015: Authentication \u2014 Credential Dumping via LSASS"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-AUTH-015_conditions"
      operator   = "OR"
