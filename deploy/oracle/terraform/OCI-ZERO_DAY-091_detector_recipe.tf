resource "oci_cloud_guard_detector_recipe" "oci-zero_day-091" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-091: Unexpected DLL Loading"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-091_conditions"
      operator   = "OR"
