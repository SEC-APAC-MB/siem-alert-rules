resource "oci_cloud_guard_detector_recipe" "oci-database-013" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-DATABASE-013: CVE-2026-21962 \u2014 HTTP Server and Oracle Weblogic Server Proxy Plug-in Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-DATABASE-013_conditions"
      operator   = "OR"
