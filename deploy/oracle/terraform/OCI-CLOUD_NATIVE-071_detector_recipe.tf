resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-071" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-071: IAM Role Assumption Chain"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-071_conditions"
      operator   = "OR"
