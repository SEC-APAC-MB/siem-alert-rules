resource "oci_cloud_guard_detector_recipe" "oci-ssrf-007" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SSRF-007: CVE-2026-83548 \u2014 SMA1000 Appliances Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SSRF-007_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-SSRF-007"
      category      = "ssrf"
      mitre_attack  = ["T1592", "T1078", "T1213", "T1190", "T1110"]
