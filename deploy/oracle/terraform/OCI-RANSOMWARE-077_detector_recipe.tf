resource "oci_cloud_guard_detector_recipe" "oci-ransomware-077" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-077: Mass File Encryption Pattern"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-077_conditions"
      operator   = "OR"
