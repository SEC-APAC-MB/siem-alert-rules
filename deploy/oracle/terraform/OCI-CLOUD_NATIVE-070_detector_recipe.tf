resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-070" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-070: Cloud Metadata Service SSRF"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-070_conditions"
      operator   = "OR"
