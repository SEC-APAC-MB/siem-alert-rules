resource "oci_cloud_guard_detector_recipe" "ghadv-1927" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-1927: OpenRemote Manager: removeAlarms cross-realm IDOR (bulk delete)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-1927_conditions"
      operator   = "OR"
