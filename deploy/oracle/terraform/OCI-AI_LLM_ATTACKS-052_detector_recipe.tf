resource "oci_cloud_guard_detector_recipe" "oci-ai_llm_attacks-052" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-AI_LLM_ATTACKS-052: Parameter Manipulation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-AI_LLM_ATTACKS-052_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-AI_LLM_ATTACKS-052"
