resource "oci_cloud_guard_detector_recipe" "ghadv-0015" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-0015: netty-incubator-codec-ohttp BinaryHttpParser: Unauthenticated CPU-exhaustion DoS via infinite loop in field-section deco"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-0015_conditions"
      operator   = "OR"
