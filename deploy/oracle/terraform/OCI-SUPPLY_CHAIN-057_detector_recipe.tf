resource "oci_cloud_guard_detector_recipe" "oci-supply_chain-057" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SUPPLY_CHAIN-057: Dependency Confusion Attack"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SUPPLY_CHAIN-057_conditions"
      operator   = "OR"
