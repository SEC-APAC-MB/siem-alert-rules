resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-067" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-067: Container Escape via Privileged Pod"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-067_conditions"
      operator   = "OR"
