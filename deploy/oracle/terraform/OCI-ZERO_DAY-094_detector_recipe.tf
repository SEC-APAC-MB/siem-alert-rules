resource "oci_cloud_guard_detector_recipe" "oci-zero_day-094" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-094: Reflective DLL Injection"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-094_conditions"
      operator   = "OR"
