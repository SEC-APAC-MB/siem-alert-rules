resource "oci_cloud_guard_detector_recipe" "oci-ransomware-078" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-078: Shadow Copy Deletion"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-078_conditions"
      operator   = "OR"
