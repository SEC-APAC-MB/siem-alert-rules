resource "oci_cloud_guard_detector_recipe" "oci-mitre-0623" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0623: Kerberos Ticket: Golden Ticket"
  description     = "Detects Kerberos Ticket: Golden Ticket (T1558.001)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0623_conditions"
      operator   = "OR"
