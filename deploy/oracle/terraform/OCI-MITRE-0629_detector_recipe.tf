resource "oci_cloud_guard_detector_recipe" "oci-mitre-0629" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0629: Remote Services: SMB"
  description     = "Detects Remote Services: SMB (T1021.002)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0629_conditions"
      operator   = "OR"
