resource "oci_cloud_guard_detector_recipe" "oci-ransomware-086" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-086: Registry Run Key Persistence for Ransomware"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-086_conditions"
      operator   = "OR"
