resource "oci_cloud_guard_detector_recipe" "oci-remote-code-execution-012" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-REMOTE-CODE-EXECUTION-012: CVE-2026-83549 \u2014 SMA1000 Appliances Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-REMOTE-CODE-EXECUTION-012_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-REMOTE-CODE-EXECUTION-012"
      category      = "remote-code-execution"
      mitre_attack  = ["T1059", "T1190", "T1078", "T1110"]
