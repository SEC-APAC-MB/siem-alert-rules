resource "oci_cloud_guard_detector_recipe" "oci-ai_llm_attacks-041" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-AI_LLM_ATTACKS-041: Direct Prompt Injection"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-AI_LLM_ATTACKS-041_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-AI_LLM_ATTACKS-041"
