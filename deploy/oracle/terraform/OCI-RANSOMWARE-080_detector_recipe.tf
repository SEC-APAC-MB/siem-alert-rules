resource "oci_cloud_guard_detector_recipe" "oci-ransomware-080" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-080: Volume Shadow Copy Tampering"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-080_conditions"
      operator   = "OR"
