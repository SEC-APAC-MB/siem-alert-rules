resource "oci_cloud_guard_detector_recipe" "oci-ssrf-006" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SSRF-006: CVE-2026-83548 \u2014 SMA1000 Appliances Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SSRF-006_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-SSRF-006"
      category      = "ssrf"
      mitre_attack  = ["T1110", "T1078", "T1592", "T1190", "T1213"]
