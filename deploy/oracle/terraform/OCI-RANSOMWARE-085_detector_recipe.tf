resource "oci_cloud_guard_detector_recipe" "oci-ransomware-085" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-085: Scheduled Task Creation for Encryption"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-085_conditions"
      operator   = "OR"
