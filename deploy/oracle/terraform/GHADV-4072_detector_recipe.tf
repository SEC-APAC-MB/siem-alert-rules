resource "oci_cloud_guard_detector_recipe" "ghadv-4072" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-4072: Netty HTTP/1.0 TE+CL Coexistence Bypasses Smuggling Sanitization"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-4072_conditions"
      operator   = "OR"
