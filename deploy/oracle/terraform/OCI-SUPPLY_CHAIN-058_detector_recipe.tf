resource "oci_cloud_guard_detector_recipe" "oci-supply_chain-058" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SUPPLY_CHAIN-058: Typosquatting Package Install"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SUPPLY_CHAIN-058_conditions"
      operator   = "OR"
