resource "oci_cloud_guard_detector_recipe" "ghadv-2476" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-2476: ConnectBot SSH Client Library: Excessive allocation and integer overflow in DER private-key parsing"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-2476_conditions"
      operator   = "OR"
