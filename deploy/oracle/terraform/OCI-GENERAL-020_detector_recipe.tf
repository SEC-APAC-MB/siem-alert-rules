resource "oci_cloud_guard_detector_recipe" "oci-general-020" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-GENERAL-020: CVE-2026-55040 \u2014 SharePoint Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-GENERAL-020_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-GENERAL-020"
      category      = "general"
      mitre_attack  = ["T1110", "T1078", "T1548"]
