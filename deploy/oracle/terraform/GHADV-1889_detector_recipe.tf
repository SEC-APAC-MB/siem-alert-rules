resource "oci_cloud_guard_detector_recipe" "ghadv-1889" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-1889: xwiki-pro-macros has remote code execution from page title and content via excerpt-include macro"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-1889_conditions"
      operator   = "OR"
