resource "oci_cloud_guard_detector_recipe" "ghadv-0035" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-0035: netty-incubator-codec-ohttp: [OHttpServerCodec] Native Direct-Memory Leak on AEAD Decryption Failure Leads to Gateway De"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-0035_conditions"
      operator   = "OR"
