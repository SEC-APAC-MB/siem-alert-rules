resource "oci_cloud_guard_detector_recipe" "oci-zero_day-096" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-096: Anomalous Service Installation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-096_conditions"
      operator   = "OR"
