resource "oci_cloud_guard_detector_recipe" "oci-endpoint-006" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ENDPOINT-006: CVE-2026-33824 \u2014 Internet Key Exchange (IKE) Service Extensions Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ENDPOINT-006_conditions"
      operator   = "OR"
