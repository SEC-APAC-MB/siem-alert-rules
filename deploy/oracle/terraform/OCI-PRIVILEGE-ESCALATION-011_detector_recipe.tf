resource "oci_cloud_guard_detector_recipe" "oci-privilege-escalation-011" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-PRIVILEGE-ESCALATION-011: CVE-2026-53362 \u2014 Kernel Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-PRIVILEGE-ESCALATION-011_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-PRIVILEGE-ESCALATION-011"
