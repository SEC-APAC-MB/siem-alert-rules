resource "oci_cloud_guard_detector_recipe" "oci-privilege-escalation-001" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-PRIVILEGE-ESCALATION-001: CVE-2026-86060 \u2014 RouterOS Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-PRIVILEGE-ESCALATION-001_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-PRIVILEGE-ESCALATION-001"
