resource "oci_cloud_guard_detector_recipe" "ghadv-1366" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-1366: OpenRemote has an incomplete fix for CVE-2026-40882: XXE in KNXProtocol.startAssetImport() allows arbitrary file read vi"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-1366_conditions"
      operator   = "OR"
