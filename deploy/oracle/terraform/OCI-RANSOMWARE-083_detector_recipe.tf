resource "oci_cloud_guard_detector_recipe" "oci-ransomware-083" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-RANSOMWARE-083: Mimikatz Credential Dumping Pre-Encryption"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-RANSOMWARE-083_conditions"
      operator   = "OR"
