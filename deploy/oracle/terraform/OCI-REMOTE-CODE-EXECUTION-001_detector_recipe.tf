resource "oci_cloud_guard_detector_recipe" "oci-remote-code-execution-001" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-REMOTE-CODE-EXECUTION-001: CVE-2026-85046 \u2014 Chromium V8 Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-REMOTE-CODE-EXECUTION-001_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-REMOTE-CODE-EXECUTION-001"
