resource "oci_cloud_guard_detector_recipe" "oci-cloud_native-075" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-CLOUD_NATIVE-075: Kubernetes Secret Decryption"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-CLOUD_NATIVE-075_conditions"
      operator   = "OR"
