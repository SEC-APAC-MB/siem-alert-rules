resource "oci_cloud_guard_detector_recipe" "oci-supply_chain-066" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SUPPLY_CHAIN-066: Dependency Version Pinning Bypass"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SUPPLY_CHAIN-066_conditions"
      operator   = "OR"
