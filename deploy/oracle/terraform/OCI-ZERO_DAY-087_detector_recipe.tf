resource "oci_cloud_guard_detector_recipe" "oci-zero_day-087" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-087: Unexpected Process Execution from Web Directory"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-087_conditions"
      operator   = "OR"
