resource "oci_cloud_guard_detector_recipe" "oci-general-003" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-GENERAL-003: CVE-2026-66384 \u2014 Artifactory Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-GENERAL-003_conditions"
      operator   = "OR"
