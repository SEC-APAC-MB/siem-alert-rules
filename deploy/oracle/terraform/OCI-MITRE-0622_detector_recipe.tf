resource "oci_cloud_guard_detector_recipe" "oci-mitre-0622" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0622: OS Credential Dumping: NTDS"
  description     = "Detects OS Credential Dumping: NTDS (T1003.003)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0622_conditions"
      operator   = "OR"
