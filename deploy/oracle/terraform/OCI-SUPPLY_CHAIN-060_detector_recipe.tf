resource "oci_cloud_guard_detector_recipe" "oci-supply_chain-060" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-SUPPLY_CHAIN-060: Malicious NPM/PyPI Package"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-SUPPLY_CHAIN-060_conditions"
      operator   = "OR"
