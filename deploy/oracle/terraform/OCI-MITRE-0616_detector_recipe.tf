resource "oci_cloud_guard_detector_recipe" "oci-mitre-0616" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0616: Masquerading: Invalid Code Signature"
  description     = "Detects Masquerading: Invalid Code Signature (T1036.001)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0616_conditions"
      operator   = "OR"
  ...
  }
  {
    ...
    labels = {
      rule_id       = "OCI-MITRE-0616"
      category      = "mitre-attack"
      mitre_attack  = ["T1036.001"]
