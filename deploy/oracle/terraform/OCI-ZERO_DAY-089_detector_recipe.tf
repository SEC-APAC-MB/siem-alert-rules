resource "oci_cloud_guard_detector_recipe" "oci-zero_day-089" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-ZERO_DAY-089: Unusual Network Connection from System Process"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-ZERO_DAY-089_conditions"
      operator   = "OR"
