resource "oci_cloud_guard_detector_recipe" "ghadv-0139" {
  compartment_id  = var.compartment_id
  display_name    = "GHADV-0139: http4k: `DigestAuthProvider.verify` did not bind to request URI"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "GHADV-0139_conditions"
      operator   = "OR"
