resource "oci_cloud_guard_detector_recipe" "oci-db-influx-001" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-DB-INFLUX-001: InfluxDB \u2014 Unauthorized Data Deletion"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-DB-INFLUX-001_conditions"
      operator   = "OR"
