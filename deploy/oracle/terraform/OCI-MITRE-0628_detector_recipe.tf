resource "oci_cloud_guard_detector_recipe" "oci-mitre-0628" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0628: Remote Services: RDP"
  description     = "Detects Remote Services: RDP (T1021.001)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0628_conditions"
      operator   = "OR"
