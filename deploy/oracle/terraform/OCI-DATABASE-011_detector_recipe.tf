resource "oci_cloud_guard_detector_recipe" "oci-database-011" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-DATABASE-011: CVE-2026-21962 \u2014 HTTP Server and Oracle Weblogic Server Proxy Plug-in Exploitation"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-DATABASE-011_conditions"
      operator   = "OR"
