resource "oci_cloud_guard_detector_recipe" "oci-mitre-0621" {
  compartment_id  = var.compartment_id
  display_name    = "OCI-MITRE-0621: OS Credential Dumping: LSASS"
  description     = "Detects OS Credential Dumping: LSASS (T1003.001)"
  ...
  detector_rules {
    ...
    condition_groups {
      group_name = "OCI-MITRE-0621_conditions"
      operator   = "OR"
